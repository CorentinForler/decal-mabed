...
if __name__ == '__main__':
    ...
    distance_matrix_path = "distance_matrix_" + str(nb_ev_max) +"_" + str(p) + "_" + str(theta) + "_" + str(sigma) + ".json"
